...
from support_triage_yaml.demo import sample_ticket
from support_triage_yaml.main import run_sample_ticket
from support_triage_yaml.schemas import (
    Classification,
    DraftReply,
    ReviewPacket,
    RoutingDecision,
...
from support_triage_yaml.workflow.pipeline import SupportTriagePipeline
...
def test_pipeline_still_has_expected_step_order() -> None:
    ...
    assert SupportTriagePipeline.steps[0].has_hook is False
    assert [step.has_hook for step in SupportTriagePipeline.steps[1:]] == [True, True, True]
